...
class Client extends _1.BaseClient {
    constructor(
    /**
     * ## ChannelType
     *
    ...
    MoreOption) {
        ...
        typeof MoreOption !== "undefined" && typeof MoreOption.maxResume !== "undefined"
            ...
            : void 0;
        this.http = new http_1.HTTPClient(`https://${this.getHost}`);
    ...
    InitIncetance() {
        this.instance = new _1.Instance(this);
    }
    __sendHelloWorld() {
    ...
    InitSelfUser() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, posts_1.GETPOST)(`https://${this.host}/api/i`, { i: this.token }).then((self) => {
                this.i = new _1.Self(self.data, this);
                this.emit("ready", () => { });
    ...
    login(token) {
        ...
        this.wsm.on("message", (msg) => {
            ...
            const MessageClass = new _1.TimeLineMessage(message, this);
